    ...
    public partial class VersaoInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_LOG = table.Column<int>(type: OracleNumber10, nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_PREVISAO_TEMPO = table.Column<int>(type: OracleNumber10, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_SENSOR = table.Column<int>(type: OracleNumber10, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_USUARIO = table.Column<int>(type: OracleNumber10, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    NOME = table.Column<string>(type: "NVARCHAR2(2000)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_LEITURA_SENSOR = table.Column<int>(type: OracleNumber10, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    ID_SENSOR = table.Column<int>(type: OracleNumber10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_ALERTA = table.Column<int>(type: OracleNumber10, nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 1 INCREMENT BY 1"),
                    ID_USUARIO = table.Column<int>(type: OracleNumber10, nullable: true),
                    ID_SENSOR = table.Column<int>(type: OracleNumber10, nullable: true),
                    ID_PREVISAO_TEMPO = table.Column<int>(type: OracleNumber10, nullable: true),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "LOG_API");
            migrationBuilder.DropTable(name: "PREVISAO_TEMPO");
